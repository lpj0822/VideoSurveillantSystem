...
class VehicleConverseConfigureWindow : public QDialog
{
    Q_OBJECT
public:
    explicit VehicleConverseConfigureWindow(QImage image, QWidget *parent = 0);
    ~VehicleConverseConfigureWindow();
